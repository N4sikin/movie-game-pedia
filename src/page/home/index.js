...
const Home = () => {
  ...
  return (
    <>
      ...
      {dataPublicMovies.length > 0 ? (
        <Link to='/movies' className='link'>
          <Button sx={{ width: '100%', padding: '10px' }} variant="contained">Show All Movies</Button>
        </Link>
      ) : null}
      ...
      {dataPublicGames.length > 0 ? (
        <Link to='/games' className='link'>
          <Button sx={{ width: '100%', padding: '10px' }} variant="contained">Show All Games</Button>
        </Link>
      ) : null}
    </>
  )
